...
class RobotLoader extends AutoLoader
{
	...
	private function scanDirectory($dir)
	{
		if (is_dir($dir)) {
			...
			$iterator = Finder::findFiles(is_array($this->acceptFiles) ? $this->acceptFiles : Strings::split($this->acceptFiles, '#[,\s]+#'))
