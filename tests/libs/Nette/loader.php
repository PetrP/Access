...
/**
 * Nette Framework (version 2.0.4 released on 2012-07-30, http://nette.org)
 *
...
{
	if ($m === NULL) {
		return $callback instanceof Callback ? $callback : new Callback($callback);
	}
	return new Callback(array($callback, $m));
}
